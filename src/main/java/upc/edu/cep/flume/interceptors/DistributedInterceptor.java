...
//        try {
//            Files.write(Paths.get("/home/osboxes/upc-cep/cep2.txt"), (eventName +"\n").getBytes(), StandardOpenOption.APPEND);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
    }
...
//                        try {
//                            Files.write(Paths.get("/home/osboxes/upc-cep/cep2.txt"), ("possible" +"\n").getBytes(), StandardOpenOption.APPEND);
//                        } catch (IOException e) {
//                            e.printStackTrace();
//                        }
                        possible = false;
    ...
    public static class Builder implements Interceptor.Builder {
        ...
        public void configure(Context context) {
            ...
            //System.out.println("______________________________________________________________________ "+rules.size());
            ...
            if (rules.size() > 0) {
                ...
                for (String rule : rules) {
//                    try {
//                        Files.write(Paths.get("/home/osboxes/upc-cep/cep2.txt"), (rule +"\n").getBytes(), StandardOpenOption.APPEND);
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
