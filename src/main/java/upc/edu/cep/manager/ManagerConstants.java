...
public class ManagerConstants {
    ...
    public static final String SOURCE_ZOOKEEPER_CONNECT = "zookeeperConnect";
    ...
    public static final String EVENTNAME_INTERCEPTOR_PREFIX = INTERCEPTORS_PREFIX + "EventNameInterceptor.";
    public static final String EVENTNAME_INTERCEPTOR_EVENTNAME = EVENTNAME_INTERCEPTOR_PREFIX + "eventName.";
    public static final String EVENTNAME_INTERCEPTOR_TYPE = EVENTNAME_INTERCEPTOR_PREFIX + TYPE;
    public static final String EVENTNAME_INTERCEPTOR_TYPE_INSTANCE = "upc.edu.cep.flume.interceptors.EventNameInterceptor$Builder";
